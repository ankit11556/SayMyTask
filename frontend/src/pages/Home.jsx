...
const Home = () => {
  ...
  return (
    <>
      ...
      <section
        className="bg-gradient-to-r from-gray-100 to-gray-50 py-12 px-6 text-center shadow-lg hover:shadow-xl transition-all"
        ref={demoRef}
      >
        ...
        <p className="text-gray-700 mb-6 text-lg font-[Poppins]">
          Hear how this app will remind <strong>you by name</strong> at the
          right time.
        </p>
        <button
          onClick={() => {
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:cursor-pointer shadow-md hover:shadow-xl"
        >
          ▶️ Play Voice Demo
        </button>
      ...
      <section id="features" className="py-16 px-6 bg-white text-center animate__animated animate__fadeInUp">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-blue-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-all hover:-translate-y-1  duration-300">
            <h3 className="text-xl font-semibold mb-2 text-blue-700 font-[Poppins]">
              Voice Reminders
            </h3>
            <p className="text-gray-700 font-[Poppins]">
              Get reminded in your own voice. More personal, more effective!
            </p>
          </div>
          <div className="bg-indigo-100 p-6 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            <h3 className="text-xl font-semibold mb-2 text-indigo-700 font-[Poppins]">
              Language Support
            </h3>
            <p className="text-gray-700 font-[Poppins]">
              Supports multiple languages: English, Hindi, Tamil, Korean &
              Italian.
            </p>
          </div>
          <div className="bg-pink-100 p-6 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
      ...
      <section id="workflow" className="py-16 px-6 bg-gray-100 text-center animate__animated animate__fadeInUp">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center">
            <div className="bg-blue-600 text-white w-12 h-12 flex items-center justify-center rounded-full mb-4 font-bold hover:scale-110 transition-all duration-300">
              1
            </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-[Poppins]">
              Get Reminded by Voice at the Right Time
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-blue-500  text-white text-center animate__animated animate__fadeInUp">
        ...
        <p className="text-lg mb-6 font-[Poppins]">
          Create your first voice reminder now!
        </p>
        <Link
          to="/set-reminder"
